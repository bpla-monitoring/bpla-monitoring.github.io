var updated = [//тут указываем скрипты которые не должны жестко кешироваться
    ...
    "https://alexpyatunin.github.io/sw.js"//указал сам скрипт service worker, чтобы не кешировался жестко в будущем. Проверил. Оффлайн режим работает без него в этом кеше.
    ];
